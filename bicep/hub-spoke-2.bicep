...
param vnetHubAddressPrefix string = '10.0.0.0/22'

param bastionSubnetPrefix string = '10.0.1.0/26'

param gatewaySubnetPrefix string = '10.0.2.0/27'

param azureFirewallSubnetPrefix string = '10.0.3.0/26'

param spokeOneVnetAddressPrefix string = '10.100.0.0/22'
